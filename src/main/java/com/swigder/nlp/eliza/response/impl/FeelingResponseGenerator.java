...
public class FeelingResponseGenerator extends RandomResponseGenerator {
    ...
    private static final Map<Pattern, List<String>> patterns = new ScalarListMapBuilder<Pattern, String>()
            ...
            .put(Pattern.compile("I(?:'m|am)? (?:feel(?:ing))? ?(sad|depressed|annoyed|miserable).*"), "I am sorry that you are $1.", "Since when have you been feeling $1?", "Why are you feeling $1?")
            .put(Pattern.compile("I(?:'m|'ve been)? (?:am|feel(?:ing)) ?(happy|doing well).*"), "I am glad that you are $1.")
            .put(Pattern.compile("I feel .*"), "Why do you feel that way?", "Tell me more about that feeling.")
            .put(Pattern.compile("(?:I am|I'm) (\\w+)"), "Why are you $1?", "Do you think it is good that you are $1?")
            .put(Pattern.compile("I am (?:very|quite|a little)? ?(.*)"), "Why are you $1?")
