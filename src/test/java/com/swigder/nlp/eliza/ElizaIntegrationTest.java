 ...
 * TODO setting this test to ignore because while it works just fine in IntelliJ, it breaks when run from gradlew command line.
 */
@Ignore
...
public class ElizaIntegrationTest {
    ...
    public void eliza() throws IOException {
        ...
        await().atMost(5, TimeUnit.SECONDS).until(output,
                is(anyOf(
